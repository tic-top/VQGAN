...
- VQGAN is an open-source project created by researchers in **CAIRI AI Lab**.
- This repo borrows the basic code implementations from [taming-transformers](https://github.com/CompVis/taming-transformers).
