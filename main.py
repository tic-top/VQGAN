    ...
    try:
        ...
        default_logger_cfgs = {
            ...
            "testtube": {
                ...
                # "target": "vqgan.core.test_tube.TestTubeLogger",
                "params": {
                    "name": "testtube",
                    "save_dir": logdir,
                }
        ...
        trainer_kwargs["checkpoint_callback"] = instantiate_from_config(modelckpt_cfg)  # remove for the new version

        # add callback which sets up log directory
        default_callbacks_cfg = {
            "setup_callback": {
                "target": "vqgan.utils.main_utils.SetupCallback",
                "params": {
                    "resume": opt.resume,
                    "now": now,
                    "logdir": logdir,
            ...
            "image_logger": {
                "target": "vqgan.datasets.dataloader.ImageLogger",
                "params": {
                    "batch_frequency": 750,
                    "max_images": 4,
                    "clamp": True
